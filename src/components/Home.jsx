  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      >
        ...
        >
          Hi, I'm a professional <span className="text-white font-medium">Aspiring Data Analyst</span> specializing in automated ETL pipelines, analytical dashboarding, and complex exploratory dat[...]
        </motion.p>
        ...
        >
          <button
            ...
            className="group flex items-center gap-2 bg-brand-accent text-brand-bg px-6 py-3 rounded font-semibold text-sm hover:bg-white transition-all w-full sm:w-auto justify-center cursor-poin[...]"
          >
            View Projects
          ...
          <a
            href="#resume"
            className="flex items-center gap-2 border border-brand-card bg-brand-card/30 text-white px-6 py-3 rounded font-semibold text-sm hover:bg-brand-card transition-all w-full sm:w-auto just[...]"
          >
            Download Resume
