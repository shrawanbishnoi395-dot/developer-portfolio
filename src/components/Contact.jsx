      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5">
          ...
          <div className="space-y-4">
            ...
            <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noreferrer" className="flex items-center gap-3 text-sm text-brand-textMuted hover:text-white transition-colors p-3 bg-brand-card/40[...]"
